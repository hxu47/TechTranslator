...
# Add more deploy_stack commands here as you create more templates
# For example:
# deploy_stack "${STACK_NAME_PREFIX}-cognito" "infrastructure/cognito.yaml" \
#     "ParameterKey=ProjectName,ParameterValue=$PROJECT_NAME"

echo -e "${GREEN}All resources for $PROJECT_NAME have been deployed successfully!${NC}"#!/bin/bash
# deploy.sh - Script to deploy the TechTranslator CloudFormation stacks
